...
class Squirrel(models.Model):
    ...
    color = models.CharField('Color',max_length = 50,default = None,choices = CHOICE3)
    CHOICE4 = {('Above Ground','Above Ground'),('Ground Plane','Ground Plane'),('None','None'),}
    location = models.CharField('Location',max_length = 50,default = None,choices = CHOICE4)
    ...
    other_activity = models.CharField('Other_activity',max_length = 50,default = None)
